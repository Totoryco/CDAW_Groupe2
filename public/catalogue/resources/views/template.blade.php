...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Lobby Display') }}</title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="{{ url('/') }}">{{ config('app.name', 'Laravel') }}<i class="fa fa-home nav-icons" style="font-size: 26px;"></i></a>
                    ...
                    <ul class="navbar-nav mr-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        @else
                            <li class="nav-item dropdown mr-auto">
                                <a class="nav-link dropdown-toggle" style="font-size: 18px;" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-user nav-icons"></i> {{ Auth::user()->name }}</a>
