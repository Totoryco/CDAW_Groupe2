        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Groupe 2 - CRUD</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">by BARGE and HERSEMEULE</li>
                    </ol>
                    <div class="row">
                    ...
                    <table id="datatablesSimple"class="table table-striped" style="width:30%">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Name</th>
